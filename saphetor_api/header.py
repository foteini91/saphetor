...
##FILTER=<ID=UM,Description="Unbalanced Mapping to the forward and reverse strands, based on a binomial test, p-value 0.05">
##INFO=<ID=AC,Number=A,Type=Integer,Description="Allele count in genotypes, for each ALT allele, in the same order as listed">
##INFO=<ID=AF,Number=A,Type=Float,Description="Allele frequency, for each ALT allele, in the same order as listed">
##INFO=<ID=AN,Number=1,Type=Integer,Description="Total number of alleles in called genotypes">
##INFO=<ID=BaseQRankSum,Number=1,Type=Float,Description="Z-score from Wilcoxon rank sum test of Alt Vs. Ref base qualities">
##INFO=<ID=CGDinheritance,Number=.,Type=String,Description="Clinical Genomic Database inheritance">
##INFO=<ID=ClinVarClass,Number=.,Type=Integer,Description="ClinVar class">
##INFO=<ID=ClinVarDisease,Number=.,Type=String,Description="ClinVar disease">
##INFO=<ID=ClippingRankSum,Number=1,Type=Float,Description="Z-score From Wilcoxon rank sum test of Alt vs. Ref number of hard clipped bases">
##INFO=<ID=DANN_score,Number=.,Type=String,Description="DANN score">
...
##INFO=<ID=MutationTaster_pred,Number=.,Type=String,Description="Mutation taster prediction">
##INFO=<ID=MutationTaster_score,Number=.,Type=String,Description="Mutation taster Score">
...
##INFO=<ID=coding_impact,Number=.,Type=String,Description="Coding impact">
##INFO=<ID=cosmicFathMMPrediction,Number=1,Type=String,Description="FathMMP prediction from COSMIC">
##INFO=<ID=cosmicFathMMScore,Number=1,Type=Float,Description="FathMMP score from COSMIC">
##INFO=<ID=function,Number=.,Type=String,Description="Variant function within a transcript containing this variant">
##INFO=<ID=gnomadExomes_AC,Number=A,Type=Integer,Description="gnomAD exomes allele count">
##INFO=<ID=gnomadExomes_AC_Hemi,Number=A,Type=Integer,Description="gnomAD exomes hemizygous count">
##INFO=<ID=gnomadExomes_AC_Hom,Number=A,Type=Integer,Description="gnomAD exomes homozygous count">
##INFO=<ID=gnomadExomes_AF,Number=A,Type=Float,Description="gnomAD exomes allele frequency">
##INFO=<ID=gnomadExomes_AN,Number=A,Type=Integer,Description="gnomAD exomes allele number">
##INFO=<ID=gnomadGenomesAC,Number=A,Type=Integer,Description="gnomAD genomes allele count">
##INFO=<ID=gnomadGenomesAN,Number=A,Type=Integer,Description="gnomAD genomes allele number">
##INFO=<ID=gnomadGenomes_AC_Hemi,Number=A,Type=Integer,Description="gnomAD genomes hemizygous count">
##INFO=<ID=gnomadGenomes_AC_Hom,Number=A,Type=Integer,Description="gnomAD genomes homozygous count">
##INFO=<ID=gnomadGenomes_AF,Number=A,Type=Float,Description="gnomAD genomes allele frequency">
##INFO=<ID=hgvs,Number=.,Type=String,Description="HGVS coding DNA nomenclature">
...
##SentieonCommandLine.Haplotyper=<ID=Haplotyper,Version="sentieon-genomics-201704.03",Date="2018-03-02T17:00:13Z",CommandLine="/devel/software/sentieon-201704.03/libexec/driver -r /devel/genomes/hg19/hg19.noalt.fa -t 46 -i sample.bam --algo Haplotyper --emit_conf=10 --call_conf=30 --annotation SAC sentieon/variants.vcf">
...
##bcftools_normVersion=1.6+htslib-1.6
##bcftools_normCommand=norm -m -any -NO v 17339.1.vcf; Date=Fri Mar  2 18:21:02 2018
##bcftools_normVersion=1.9+htslib-1.9
##bcftools_normCommand=norm -m -any -NO z -o 18564.2.vcf 18564.1.vcf; Date=Mon May  4 16:52:57 2020
